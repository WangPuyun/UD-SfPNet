...
def wrap_model_distributed(model, local_rank):
    ...
    # DCC颜色嵌入模块的最后一层不需要参与梯度计算
    model.r_net.pce.cma_1.conv[0].weight.requires_grad = False
    model.r_net.pce.cma_1.conv[0].bias.requires_grad = False
